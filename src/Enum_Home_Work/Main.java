        ...
        while (menuWork) {
            ...
            switch (clientChoice) {
                ...
                case "02": {
                    ...
                    System.out.println();
                    for (int i = 0; i < Month.values().length; i++) {
                        if (month[i].getSeasons().equals(Month.valueOf(monthClient.toUpperCase()).getSeasons())) {
                            System.out.println(month[i].toString());
                        }
                    }
                    break;
                ...
                case "05": {
                    ...
                    for (int i = 0; i < seasons.length; i++) {
                        if (seasons[i].equals(Month.valueOf(monthClient.toUpperCase()).getSeasons())) {
                            System.out.println("This season is : = " + Month.valueOf(monthClient.toUpperCase()).getSeasons());
                            if (i == 3) {
